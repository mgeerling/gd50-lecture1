...
function PipePair:init(y)
    ...
    --TODO use pipe width to make sure you never overlap 
    self.x = VIRTUAL_WIDTH + math.random(10,75)
    ...
    self.pipes = {
        ...
        -- changes the gap between pipes randomly - maybe we make it skinnier as time goes on? 
